...
namespace ProductAdd
{
    public class ProductClass
    {
        ...
        public ProductClass(string ProductName, string Category, string ManufacturingDate, string ExpirationDate, double Price, int Quantity, string Description)
        {
        ...
        public string manufacturignDate
        {
